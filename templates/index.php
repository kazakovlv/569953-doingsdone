    ...
    <nav class="tasks-switch">
        <?php if (isset($active_project)) {?>
             <?php if (isset($filter_task)) {?>
                ...
                <?php }?>
                <?php if ((string)$filter_task === "today") {?>
                ...
                <?php }?>
                <?php if ((string)$filter_task === "tomorrow") {?>
                ...
                <?php }?>
                <?php if ((string)$filter_task === "overdue") {?>
